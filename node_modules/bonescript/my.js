...
exports.create_dt = function(pin, data) {
    var done = 0;
    var fragment = 'bspm_' + pin.key + '_' + data.toString(16);
    ...
    dts = dts.replace(/___PIN_KEY___/g, pin.key);
    dts = dts.replace(/___PIN_DOT_KEY___/g, pin.key.replace(/_/, '.'));
    dts = dts.replace(/___PIN_FUNCTION___/g, pin.options[data&7]);
    dts = dts.replace(/___PIN_OFFSET___/g, pin.muxRegOffset);
    dts = dts.replace(/___DATA___/g, '0x' + data.toString(16));
