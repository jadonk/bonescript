...
getPinMode = exports.getPinMode = function(pin, callback) {
    ...
    if(callback) {
        ...
        try {
            ...
            try {
                var data = fs.readFileSync(pinctrlFile, 'utf8');
                mode = parse.modeFromPinctrl(data, muxRegOffset, 0x44e10800, mode);
            } catch(ex2) {
...
removeLoops = exports.removeLoops = function(callback) {
    getLoops(function(x) {
...
readTextFile = exports.readFile = function(filename, callback) {
    var cb = function(err, data) {
        callback({'err':err, 'data':data});
    }
    fs.readFile(filename, encoding='ascii', cb);
};

writeTextFile = exports.writeFile = function(filename, data, callback) {
    var cb = function(err) {
        callback({'err':err});
    }
    fs.writeFile(filename, data, encoding='ascii', cb);
};
    ...
    addSocketListeners = function(server, onconnect) {
        ...
        io.sockets.on('connection', function(socket) {
            ...
            var myfuncs = {
                ...
                'removeLoops': { func: removeLoops, args: [] },
                'readTextFile': { func: readTextFile, args: [ 'filename' ] },
                'writeTextFile': { func: writeTextFile, args: [ 'filename', 'data' ] }
            };
