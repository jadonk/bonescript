...
f.getPlatform = function(callback) {
    ...
    if(file_existsSync('/sys/devices/bone_capemgr.8/baseboard/board-name')) {
        platform.name = fs.readFileSync('/sys/devices/bone_capemgr.8/baseboard/board-name', 'ascii');
        platform.version = fs.readFileSync('/sys/devices/bone_capemgr.8/baseboard/revision', 'ascii');
        platform.serialNumber = fs.readFileSync('/sys/devices/bone_capemgr.8/baseboard/serial-number', 'ascii');
    }
