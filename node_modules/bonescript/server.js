    ...
    function onconnect(socket) {
        ...
        var callMyFunc = function(name, m) {
            var myCallback = function(resp) {
                if(typeof m.seq == 'undefined') {
                    winston.debug('m.seq undefined: ' + name + ' ' + JSON.stringify(m));
		    return;
                }
                if(typeof resp != 'object') resp = {'data': resp};
		resp.seq = m.seq;
            ...
            try {
                ...
                for(var arg in b[name].args) {
                    ...
                    if(argname == 'callback') {
                        winston.debug('Assigning callback to ' + name);
                ...
                winston.debug('callargs = ' + JSON.stringify(callargs));
                winston.debug('myCallback = ' + myCallback);
